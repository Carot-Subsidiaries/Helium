...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Helium's Upvalue Scanner: https://github.com/Upbolt/Helium

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Upbolt/Helium/revision/ohaux.lua"))()
