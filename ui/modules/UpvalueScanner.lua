...
local Base = import("ui/interface.rbxm").Base
local Assets = import("ui/assets.rbxm").UpvalueScanner
...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Helium's Upvalue Scanner: https://github.com/Carot-Subsidiaries/Helium

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Carot-Subsidiaries/Helium/revision/ohaux.lua"))()
